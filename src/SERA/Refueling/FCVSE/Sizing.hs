...
module SERA.Refueling.FCVSE.Sizing {-# DEPRECATED "This module is obsolete and will be refactored or removed." #-} (
...
instance ToJSON InfrastructureUtilizationParameters where
...
instance ToJSON StationCapacityParameters where
  toJSON = genericToJSON defaultOptions
